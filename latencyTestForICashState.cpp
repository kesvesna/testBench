...
//======================================================================
		...
		for ( long long i = 0; i < iterations; ++i )
		{
			...
			if ( !dataSizeIsStored )
			{
				fout << "arrDataSize = [ arrDataSize " << bufferSize * 64 << " ]; " << endl;
...
//======================================================================
   ...
   // {
	//	tempCasTime /= iterations;
	//	tempFaaTime /= iterations;
...
int main ()
{
	...
	fout << "grid on" << endl;
	fout << "titleString = sprintf('latency test for Invalidate Cash, testRuns = %d, iterations = %d, buffer size = %d bytes', testRuns, iterations, bufferSize);" << endl;
